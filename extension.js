...
// This reduced variant keeps only the focused-window lookup and geometry
// query needed by the Flutter plugin. GNOME Shell has no generic external
// window geometry API, so a tiny companion extension remains the
// least-coupled path.
